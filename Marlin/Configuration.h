...
#define STRING_CONFIG_H_AUTHOR "(Michael Prusai3, Increase extruder Flow)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {106.6667, 106.6667, 4000, 127.4}
